# Gurveer Sidhu — Data Science & AI Portfolio

A curated portfolio of end-to-end machine learning systems, agentic AI workflows, LLM evaluation pipelines, and quantitative modeling across finance and aviation.

This repository reflects how I **design, evaluate, and iterate on real systems** — not just isolated models.

---

## 👨‍💻 About Me

I’m a Data Science student focused on building systems that go beyond predictions — systems that **reason, evaluate, and act**.
My work has transitioned from classical machine learning to include:

- Agentic AI workflows
- Retrieval-augmented generation (RAG)
- Reinforcement learning from feedback (RLHF-style systems)
- Quantitative modeling in finance and aviation

I approach problems with a systems mindset, focusing not just on whether the model works, but also on how it behaves, improves, and integrates into real workflows.

This portfolio is intentionally iterative; projects are continuously upgraded with:
...
- Alignment-focused system design  
...
- Interpretability-focused approach  
...
- Feature engineering + model orchestration  
- **ROC AUC: 0.8618**
...
- CAT I constraints  
- Aviation-focused system design  
...
**LLMs:** LangChain, LangGraph, RAG, FAISS  
**Data:** Pandas, NumPy, DuckDB  
**Evaluation:** ROUGE, BERTScore, SHAP  
**Quant:** Monte Carlo, Black-Scholes  

---

## 📁 Repository Structure

- project-01-credit-risk  
